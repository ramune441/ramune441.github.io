...
| `/subduo/promo[-lang].mp4` | 動画 | - | no | YouTube 掲載用 4K（H.264 High/yuv420p/3840x2160/30fps + AAC 192k BGM `mp3/271_BPM110.mp3` 音量0.85・0.6s フェードイン・2s フェードアウト）。掲載タイトル/説明文は `subduo/youtube.json`。各言語のストア掲載情報のプロモーション動画欄に `https://www.youtube.com/watch?v=<ID>` を設定 |
