...
| `/sendready-chrome/promo.mp4` `promo-<lang>.mp4` | 動画 | - | no | YouTube 掲載用（H.264 High/yuv420p/1080p/30fps + AAC BGM、約4MB）。BGM は既存動画と同一音源。**YouTube 公開済み（チャンネル: Just One More Animal、タイトル「SendReady ChromeExtension (言語名)」）**: en=OQZm31RK-x8 / ja=NJqbBFWLN-k / zh=yJR8x0rH1zA / ko=BH1EKyo8-Ps / es=2ze7BbAuOto / fr=mFGpgYhSUvQ / de=IETp6mHNaY0 / pt=ZbrtrY4LEE0 / hi=GLvvVN1pxGM / id=lJnJpm6SXxQ / ar=VE7hBf_62mo（URL は `https://youtu.be/<ID>`）。各言語のストア掲載情報のプロモーション動画欄にこの URL を設定する（デベロッパーコンソールは拡張から操作不可のため手動） |
