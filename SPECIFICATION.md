...
| `/ashiato-maker/store-image-{1..5}.png` | ストア画像 | - | no | 1280x800。動画と同一ライトモードデザイン（1=イントロ、2=実稼働デモ+訪問中コールアウト、3=ポチポチ比較、4=機能6グリッド、5=実稼働デモ+自動リロードコールアウト）。1920x1080素材を中央1728x1080クロップ→縮小 |
